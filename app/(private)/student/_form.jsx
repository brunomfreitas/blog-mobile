...
export default function StudentForm() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      router.replace("/(private)/student/manage");
    } catch (e) {
  ...
  if (loading) {
    return (
      <>
        <Stack.Screen options={{ title: isEdit ? "Editar Aluno" : "Novo Aluno" }} />
  ...
  return (
    <>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <Text style={styles.h1}>{isEdit ? "Editar Aluno" : "Novo Aluno"}</Text>
